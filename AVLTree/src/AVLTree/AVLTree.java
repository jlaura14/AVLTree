...
/**
 *
 * @author fires blog: http://proyectosbeta.blogspot.com/
 */
...
public class AVLTree<T extends Comparable<T>> implements Comparable<T> {
	...
	/*
	 * Imprime cada nodo linea por linea. Recorriendo el arbol desde el Nodo más a
	 * la derecha hasta el nodo más a la izquierda, y dejando una identacion de
	 * varios espacios en blanco segun su altura en el arbol
	 */
